...
namespace FreeEDR.Internal.DataService
{
    public class MailService : IMailService
    {
        ...
        public void GetMail(string sender, string recipient, string subject, string body)
        {
            SmtpClient client = new SmtpClient("smtp.live.com");
        ...
        public void GetMailAttach(string sender, string recipient, string subject, string body, string attachment)
        {
            SmtpClient client = new SmtpClient("smtp.live.com");

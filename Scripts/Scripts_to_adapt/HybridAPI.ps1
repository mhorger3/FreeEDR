#This API script pulls in all functionality of Hybrid Analysis. The big issue with this is that normal Hybrid Analysis is considerably slow per sample. It also incorporates VirusTotal
